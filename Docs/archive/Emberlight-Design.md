> # ⛔ 已归档 · 请勿实现
> **本文是 2026-09-13 的设计与开发记录，含已过期数值，不可作为现行口径。**
>
> 现行文档：
> - 产品行为 / 范围 / 数值 → `../requirements.md`
> - 模块边界与任务路由 → `../architecture/00-overview.md`
> - 难度与波次 → `../architecture/03-combat-waves.md`
> - 选卡与构筑 → `../architecture/02-run-progression.md`
> - 武器与专属/质变 → `../architecture/04-weapon-system.md`
>
> 具体过期项：本文仍写「Wave6 Boss / 6 波节奏」、「难度血量 ×0.75 ×1 ×1.35」、
> 「局外成长」相关内容、以及指向 `Docs/Difficulty-Waves-v3.md` 等已移动路径的链接。
> 现行局长为 **25 / 50 波**，血量倍率为 **0.25 / 0.5 / 0.675**，局外成长**已删除**。
