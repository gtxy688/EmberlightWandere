...
namespace Emberlight
{
    ...
    {
        // Pre-warm list for the dynamic atlas. Note it is NOT exhaustive: characters the UI
        ...
        // them. Anything that appears on the loading screen or in the main menu belongs here so
        // it is ready before the player sees it. The tail below is the game-speed feature.
