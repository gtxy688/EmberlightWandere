    ...
    public sealed class EmberGame : MonoBehaviour
    {
        ...
        public void ShowMainMenu()
        {
            ...
            ui.Show(
                ...
                GameSpeed.ShouldShowHint ? MenuHint : null,
        ...
        void ChooseLength(int waves)
        {
            ...
            ui.Show(DifficultyTitle, DifficultyBody(selectedWaves),
                DifficultyChoices,
        ...
        public void Pause()
        {
            ...
            if (ui.SettingsPanel != null)
                ...
                ui.Show(PauseTitle, PauseBody, new[] { PauseChoice }, new UnityEngine.Events.UnityAction[] { SetPlaying });
        }
        ...
        void End(bool won)
        {
            ...
            EmberAudio.Ensure().PlayMenuMusic();
            ui.Show(won ? WinTitle : LoseTitle,
                ...
                new[] { RestartChoice, ReturnChoice }, new UnityEngine.Events.UnityAction[] { BeginRun, ShowMainMenu });
        }
