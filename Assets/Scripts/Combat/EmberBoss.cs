...
namespace Emberlight
{
    ...
    {
        public enum AttackState { Pursuit, DashWarning, Dash, EruptionWarning, Recovery }
        ...
        public EmberBoss(EmberGame owner,Transform root,Transform arena)
        {
            game=owner;body=root;world=arena;
        ...
        string Label(){switch(State){case AttackState.DashWarning:return "\u51b2\u950b\u9884\u8b66";case AttackState.Dash:return "\u6697\u5f71\u51b2\u950b";case AttackState.EruptionWarning:return "\u6697\u7130\u7206\u53d1";case AttackState.Recovery:return "\u7834\u7efd";default:return "\u8ffd\u730e";}}
